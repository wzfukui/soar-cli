# 持续进化：雾帜智能推出轻量级终端神器 SOAR-CLI，打通 AI Agent 与安全编排的最后一公里！
...
- **UniMCPServer**：以大模型上下文协议（MCP）为桥梁，统一多源能力聚合；
...
从此，AutoGPT、LangChain 或你们自己编写的各种野生 AI 调度脚手架，能极其精准地解析 SOAR 所有的剧本清单、出入参数甚至运行节点细节日志。
...
👉 **项目地址**：[https://github.com/flagify-com/soar-cli](https://github.com/flagify-com/soar-cli)

同时别忘了我们的兄弟矩阵，构建您的全方位智能运营体系：
- [SOAR-MCP 端](https://github.com/flagify-com/soar-mcp)
- [OctoMation 核心引擎](https://github.com/flagify-com/OctoMation)
